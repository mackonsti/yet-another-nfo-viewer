...
#ifndef YANVI_SWIFT_H
#define YANVI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="YaNVi",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5YaNVi11AppDelegate")
@interface AppDelegate : NSObject <NSApplicationDelegate>
@property (nonatomic, weak) IBOutlet NSWindow * _Null_unspecified nfoWindow;
@property (nonatomic, strong) IBOutlet NSTextView * _Null_unspecified nfoTextView;
...
SWIFT_CLASS("_TtC5YaNVi12EscapeWindow")
@interface EscapeWindow : NSWindow
